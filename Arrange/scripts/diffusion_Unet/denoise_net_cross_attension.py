...
from graph_net import GraphTripleConvNet, _init_weights, make_mlp
import numpy as np
...
from attension import SpatialTransformer, SpatialTransformer1D
...
class UNet1DModel(nn.Module):
    ...
    def __init__(
        ...
        gconv_kwargs_box = {
            'input_dim_obj': gconv_dim * 2+64,#256+64
            'input_dim_pred': gconv_dim ,#128
